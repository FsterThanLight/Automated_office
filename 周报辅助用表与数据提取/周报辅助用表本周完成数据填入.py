...
wb_1=load_workbook('周报辅助用表.xlsx')
sht_1=wb_1['周报辅助用表']
path=sht_1['b33'].value

s_date=input('周开始时间：').replace('.','/')
e_date=input('周结束时间：').replace('.','/')
if s_date=="":
    s_date='2021/1/1'
if e_date=='':
    e_date='2024/1/1'
...
sht_1['b12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','25m','梁片预制')
sht_1['c12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','40m','梁片预制')
sht_1['b13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','25m','梁片预制')
sht_1['c13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','40m','梁片预制')

sht_1['d12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','25m','梁片安装')
sht_1['e12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','40m','梁片安装')
sht_1['d13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','25m','梁片安装')
sht_1['e13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','40m','梁片安装')

sht_1['f12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','湿接缝长度')
sht_1['g12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','湿接缝跨数')
sht_1['f13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','湿接缝长度')
sht_1['g13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','湿接缝跨数')

sht_1['h12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','防撞护栏长度')
sht_1['i12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','防撞护栏联数')
sht_1['h13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','防撞护栏长度')
sht_1['i13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','防撞护栏联数')

sht_1['j12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','桥面铺装面积')
sht_1['k12'].value=extract_data('2021/1/1','2024/1/1','1#智慧梁厂','0','桥面铺装联数')
sht_1['j13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','桥面铺装面积')
sht_1['k13'].value=extract_data('2021/1/1','2024/1/1','2#智慧梁厂','0','桥面铺装联数')
...
s1=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','湿接缝长度')
s2=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','湿接缝跨数')
s3=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','湿接缝长度')
s4=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','湿接缝跨数')
sht_1['f14'].value=s1+s3
sht_1['g14'].value=s2+s4

f1=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','防撞护栏长度')
f2=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','防撞护栏联数')
f3=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','防撞护栏长度')
f4=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','防撞护栏联数')
sht_1['h14'].value=f1+f3
sht_1['i14'].value=f2+f4

q1=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','桥面铺装面积')
q2=extract_data('2022/1/1','2024/1/1','1#智慧梁厂','0','桥面铺装联数')
q3=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','桥面铺装面积')
q4=extract_data('2022/1/1','2024/1/1','2#智慧梁厂','0','桥面铺装联数')
try:
...
ss1=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','湿接缝长度')
ss2=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','湿接缝跨数')
ss3=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','湿接缝长度')
ss4=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','湿接缝跨数')
sht_1['f15'].value=ss1+ss3
sht_1['g15'].value=ss2+ss4

ff1=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','防撞护栏长度')
ff2=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','防撞护栏联数')
ff3=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','防撞护栏长度')
ff4=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','防撞护栏联数')
sht_1['h15'].value=ff1+ff3
sht_1['i15'].value=ff2+ff4

qq1=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','桥面铺装面积')
qq2=extract_data('2021/12/16','2024/1/1','1#智慧梁厂','0','桥面铺装联数')
qq3=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','桥面铺装面积')
qq4=extract_data('2021/12/16','2024/1/1','2#智慧梁厂','0','桥面铺装联数')
try:
...
wb_1.save('周报辅助用表'+s_date.replace('/','.')+'~'+e_date.replace('/','.')+'.xlsx')
print('数据已生成。')
